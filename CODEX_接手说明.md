...
- 上位机 .NET Framework 4.8 / WinForms，发布版本 0.3.0，单 EXE。
...
0.3.0 验收结果以 `docs/VALIDATION-0.3.0.md` 为准，0.2.0 的两小时观察保留在 `docs/VALIDATION.md`。不将旧版本持续时长套用到新版。固件和物理设备验收始终独立记录。
